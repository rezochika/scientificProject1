...
# 0.011353
ep = 2000
df = pd.read_csv(os.path.join(os.path.dirname(__file__),r'data/TbilisiData.csv'))
df1 = pd.read_csv(os.path.join(os.path.dirname(__file__),r'data/TbilisiFore.csv'))
...
if rebuild:
    ...
    model7.compile(loss=MeanSquaredError(), optimizer=Adam(learning_rate=lr),
