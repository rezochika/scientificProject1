...
cons = df1[2000:].loc[:, ['wf', 'IHT', 'wfy', 'dhdd1', 'dhdd13', 'hdd1t', 'Troloff', 'mx2', 'mn4', 'dcy', 'c7', 'cy', 'c']]
...
print(us.plot_predictions(model7, X_test1, y_test1, 'Test Predictions', 'Actuals', 'model7', meann, stdd, start=0, end=135))
exit(0)
